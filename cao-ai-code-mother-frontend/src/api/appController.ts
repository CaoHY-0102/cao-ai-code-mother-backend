...
/** 删除应用(管理员) POST /app/admin/delete */
...
/** 获取应用详情(管理员) GET /app/admin/get/vo */
...
/** 获取应用列表(管理员) POST /app/admin/list/page/vo */
...
/** 更新应用(管理员) POST /app/admin/update */
...
/** 获取精选应用列表 POST /app/good/list/page/vo */
...
/** 获取应用列表 POST /app/my/list/page/vo */
